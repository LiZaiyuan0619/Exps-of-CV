...
var PCL = (function(exports) {
    ...
    ***************************************************************************** */
    ...
    var PCLCore = (()=>{
        ...
        return (function(PCLCore) {
            PCLCore = PCLCore || {};
            var Module = typeof PCLCore != "undefined" ? PCLCore : {};
            ...
            function getBinaryPromise() {
                if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
                    if (typeof fetch == "function" && !isFileURI(wasmBinaryFile)) {
                        return fetch(wasmBinaryFile, Module["fetchSettings"] || {
            ...
            var asmLibraryArg = {
                ...
                "Z": ___cxa_rethrow,
                "d": ___cxa_throw,
                "I": ___syscall_fallocate,
                "z": ___syscall_fchmodat,
                ...
                "u": ___syscall_openat,
                "R": ___syscall_stat64,
                "ea": __embind_finalize_value_array,
                ...
                "fa": __embind_register_value_array,
            ...
            Module["___wasm_call_ctors"] = function() {
                return (Module["___wasm_call_ctors"] = Module["asm"]["ja"]).apply(null, arguments)
            }
            ;
            ...
            Module["___embind_register_native_and_builtin_types"] = function() {
                return (Module["___embind_register_native_and_builtin_types"] = Module["asm"]["pa"]).apply(null, arguments)
            }
            ;
            var _emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = function() {
                return (_emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = Module["asm"]["qa"]).apply(null, arguments)
            }
            ;
    ...
    function init(options) {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            const {arrayBuffer, url, fetchOptions: fetchSettings={
                credentials: 'same-origin'
