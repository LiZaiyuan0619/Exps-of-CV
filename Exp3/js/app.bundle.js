(()=>{
    ...
    (()=>{
        ...
        const Ae = [["点击开始或右上角的问号可以查看我的模型示例", "./images/土拨鼠嘟嘟嘟.png"], ["草图勾勒出创意的二维轮廓", "./images/sketch.gif"], ["将草图形状拉伸为三维实体", "./images/extrude.png"], ["使用其他草图来雕刻或扩展模型", "./images/sculpt.gif"], ["将您的设计导出到 3D 打印机，变成现实！", "./images/3dprint.mp4"]]
          ...
          , He = ()=>{
            ...
            }), "LiYanchao_Exp3"), t.createElement("div", {
